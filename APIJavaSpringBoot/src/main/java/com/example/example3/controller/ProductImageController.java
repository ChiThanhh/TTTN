...
import com.example.example3.entity.ProductImage; // Import the ProductImage entity
import com.example.example3.service.ProductImageService; // Import the ProductImageService
...
public class ProductImageController { // Rename the class
    ...
    // Get All ProductImages REST API
    @GetMapping
    public ResponseEntity<Page<ProductImage>> getAllProductImages(
            @RequestParam(name = "page", defaultValue = "0") int page,
            @RequestParam(name = "size", defaultValue = "10") int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<ProductImage> productImages = productImageService.getAllProductImages(pageable); // Rename the service method
